/** Provincias y municipios de España (52 provincias + Ceuta y Melilla). */
export const SPAIN_PROVINCES: readonly string[] = [
  "A Coruña",
  "Álava",
  "Albacete",
  "Alicante",
...
export const SPAIN_MUNICIPALITIES_BY_PROVINCE: Readonly<Record<string, readonly string[]>> = {
  "A Coruña": [
    "A Coruña",
    "Abegondo",
    "Amés",
...
export const ALL_SPAIN_MUNICIPALITIES: readonly string[] = Object.values(SPAIN_MUNICIPALITIES_BY_PROVINCE)
  .flat()
  .sort((a, b) => a.localeCompare(b, "es"))

export function getSpainMunicipalitiesForProvince(provincia: string): readonly string[] {
  if (!provincia) return []
  return SPAIN_MUNICIPALITIES_BY_PROVINCE[provincia] ?? []
}
