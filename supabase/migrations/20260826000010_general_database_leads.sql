-- Base de datos general de prospección comercial (ERP)
-- Lectura: comerciales, jefes, superadmin y tramitación
-- Escritura / import: solo superadmin y tramitación
...
comment on table public.general_database_leads is
  'Base de datos general de prospección (residencial, PYME, comunidades). Sin export CSV para comerciales.';
